...
# ─── Synapse Verification Routes (core product) ──────────────────────────
from app.synapse_routes import router as synapse_router
...
# ═══════════════════════════════════════════════════════════════════════════
# SYNAPSE VERIFICATION ENGINE — endpoints moved to app/synapse_routes.py
# All /api/* routes are now served via the synapse_router (included above).
# ═══════════════════════════════════════════════════════════════════════════
